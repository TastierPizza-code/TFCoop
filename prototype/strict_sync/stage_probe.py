...
REQUIRED_PYTHON = {"core.py", "replica.py", "transport.py", "runner.py",
                   ...
                   "rail_probe.py", "rail_input.py", "rail_catalog.py", "rail_engine.py",
                   "session_guard.py"}
...
REQUIRED_BUILD_FILES = {"res/scripts/tf2_strict_probe/build_engine.lua",
                        ...
                        "res/scripts/tf2_strict_probe/rail_engine.lua",
                        "res/scripts/tf2_strict_probe/rail_assets.lua",
...
def configuration_semantics(profile=None, preparation=None, input_mode=None):
    ...
    if input_mode is not None:
        if (type(input_mode) is not str or input_mode not in ("manual_depot_v1", "guided_suite_v1", "guided_rail_v1")
