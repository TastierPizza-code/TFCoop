...
**Alpha5.14-Eingabetest / v0.5.14** ergänzt einen eigenen Eingabeweg mit weniger Wartephasen und zehn Aufbaurunden. Eingabelisten reisen mit den ohnehin nötigen Schrittbestätigungen; die separate Abfrage entfällt. Rein informative Launcher-Statusupdates werden zusammengefasst. Der neue Modus soll die häufigeren Zuckler aus Alpha5.13 reduzieren; seine tatsächliche Flüssigkeit muss noch auf zwei PCs geprüft werden. [Änderungen](prototype/RELEASE_NOTES.md).

**Alpha5.12 bleibt eingefroren** und als **Referenztest aus Alpha5.12** auswählbar. Sein tatsächlicher Zwei-PC-Lauf hatte 270 identische Journaleinträge, passende erfasste Zustände und etwa 0,962x Fahrttempo. Die Spieler akzeptierten die fast unsichtbaren Zuckler. Alpha5.13 bestätigte gegenseitige Pause/Fortsetzen mit 380 identischen Weltjournalzeilen, lief aber nur etwa 0,82x. Deshalb erhält der neue Modus jetzt eine gezielte Optimierung; die bisherigen Abläufe bleiben erhalten. Siehe [akzeptierte Referenz](prototype/docs/ACCEPTED_BASELINE.md) und [Alpha5.13-Evidenz](prototype/docs/ALPHA513_EVIDENCE.md).

## Download und gemeinsamer Versuch

1. Beide Test, TF2 und Launcher schließen. Den vorhandenen Launcher ab Alpha5.2 normal öffnen und das Update auf **Alpha5.14-Eingabetest** abwarten. Bei erster Einrichtung [TFCoop-Windows.zip herunterladen](https://github.com/TastierPizza-code/TFCoop/releases/latest/download/TFCoop-Windows.zip), vollständig entpacken und `TF2-Coop.exe` öffnen. Git und Python sind nicht nötig.
...
4. Nach der Startfreigabe TF2 über Steam starten und jeweils die neu angezeigte `TF2-Koop-Messtest-….sav` laden. **TF2 Strict Sync - gemeinsamer Eingabetest (Alpha5.14)** und **Legacy Fahrzeuge** sind bereits ausgewählt. Die zufälligen Dateinamen dürfen verschieden sein.
