...
Die vollständige [Anleitung](prototype/ANLEITUNG.md) erklärt Plätze, Drehung, Rückmeldungen und Fehlerfälle. **Die Depotfunktion ist vorab mit Modellen und API-Fixtures geprüft; ein echter Zwei-PC-Spielnachweis dieser Version steht aus.** Ein regulärer Abschluss und die tatsächlich erfassten Bau-/Konfliktfälle werden getrennt bewertet.

Die akzeptierte [Alpha5.15-Referenz](prototype/docs/ACCEPTED_INPUT_BASELINE.md) mit rund 0,94x bleibt separat auswählbar. Schrittweite, Zweierserien, Pacer und regelmäßige Kontrollabstände werden im neuen Modus übernommen; sein tatsächliches Fahrgefühl muss geprüft werden. Die längere [Alpha5.12-Referenz](prototype/docs/ACCEPTED_BASELINE.md) bleibt ebenso erhalten. Die alten Tags und Pakete werden nicht ersetzt.
